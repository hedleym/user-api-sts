...
public class AWSV4Auth {
    ...
    public static class Builder {
        ...
        public Builder queryParameters(TreeMap<String, String> queryParametes) {
    ...
    private String buildAuthorizationString(String strSignature) {
        return HMACAlgorithm + " "
                + "Credential=" + accessKeyID + "/" + getDate() + "/"
    ...
    private byte[] getSignatureKey(
        ...
        byte[] kService = serviceName == null ? kRegion
                : HmacSHA256(kRegion, serviceName);
